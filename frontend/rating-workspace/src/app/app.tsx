  ...
  return (
    <Routes>
      <Route element={<AppShell />}>
        ...
        <Route path="/decision-tables" element={<div className="p-6"><h1 className="text-xl font-semibold">Decision Tables</h1><p className="text-gray-500 mt-1">Coming in Phase 2.</p></div>} />
